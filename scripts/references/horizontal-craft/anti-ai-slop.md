...
related:
  - SKILL.md (Section 8.2: Anti-Slop Injection Protocol)
  - DESIGN_BIBLE.md (design philosophy)
  - horizontal-craft/link-and-proof.md (proof standards)
  - horizontal-craft/typography.md (typography craft)
  - horizontal-craft/animation-motion.md (motion craft)
preview:
  type: none
default_for:
  - anti AI slop
...
**AI Slop** is any design decision that exists because it is the model's default habit, not because the brief, content, or design system called for it. It is the result of AI models trained on millions of similar outputs converging on the same "safe" patterns. Slop looks fine individually but produces a recognizable, soulless sameness across all AI-generated work.

**How to identify AI Slop:**
- Would this choice exist if the content, brand, or brief had been different? If yes → slop.
- Is this choice "fine" but not "specific"? If yes → slop.
- Would you see the same choice on 100 other AI-generated sites? If yes → slop.
- Did the AI add this without being asked, because it "looks professional"? If yes → slop.

**Examples of AI Slop:**
- Using indigo (#6366f1) as accent color without a brand reason
- Adding ✨🚀🎯⚡🔥💡 as feature icons
- Rounded white cards with subtle shadow everywhere
- Hero section with blue-purple gradient background
- "Loved by 10,000+ teams" with no source
- Lorem ipsum or placeholder text that looks real
- Inter / Roboto as the display font by default
- Three equal-width feature cards with icon + title + description
- Fade-in animation on every section scroll
- Stock photos of desks, laptops, sticky notes

---

## Definition: AI TEMPLATE AESTHETIC

**AI Template Aesthetic** is the specific visual signature that emerges when AI models generate web pages, landing pages, or apps without strong direction. It is a subset of AI Slop — not just individual bad choices, but a coherent default "look" that signals "this was generated, not designed."

**The AI Template Aesthetic is characterized by:**

1. **Color**: Indigo/purple accent on white/light gray, with a blue-to-purple gradient somewhere (hero, button, text). Dark mode: near-black background with purple glow.

2. **Typography**: Inter or system-ui for everything. No display font. No typographic personality. Or: italic serif word inside a sans-serif heading as the only "flair."

3. **Layout**: Centered max-width container. Hero → 3 feature cards → How it works → Testimonials → Pricing → FAQ → CTA. Every section is vertically stacked with equal spacing. No rhythm variation.

4. **Components**: Rounded cards (border-radius: 12-16px) with 1px border and subtle shadow. Pill badges with colored dots. Gradient primary button + outline ghost button. Fully rounded CTA buttons with shadow.

5. **Motion**: Fade-in on scroll everywhere. Parallax on hero. Bouncing hover on buttons. No intentional choreography.

6. **Imagery**: Floating device mockup with reflection. Stock photo of "team collaboration." Unsplash desk with coffee. Fake product screenshot.

7. **Copy**: "Empower your team." "Seamless workflow." "Unlock your potential." "Trusted by industry leaders." Fake metrics. Fake logos.

8. **Texture**: Full-page dot grid pattern. Gradient mesh background. Noise overlay. Blob shapes.

**How to avoid the AI Template Aesthetic:**
- Make every design choice tied to a specific content reason, not a default.
- Choose a color territory, not a color value. "Cinnabar and ink" not "#6366f1."
- Break the layout rhythm. Use asymmetry, density variation, editorial flow.
- Use typography as identity, not just readability.
- One signature visual idea, not five generic ones.
- Real content or honest placeholders. Never fake proof.
- Motion with purpose, not motion for the sake of motion.
